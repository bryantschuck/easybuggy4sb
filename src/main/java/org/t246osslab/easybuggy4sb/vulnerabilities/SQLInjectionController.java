...
public class SQLInjectionController extends AbstractController {
    ...
    public ModelAndView process(@RequestParam(value = "firstName", required = false) String name, @RequestParam(value = "password", required = false) String password, ModelAndView mav,
